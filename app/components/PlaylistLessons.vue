  ...
  <div class="flex flex-col gap-y-4 lg:col-span-1">
    <div class="flex items-center justify-between gap-x-4">
      ...
      <div class="flex gap-x-2">
        <a href="#" target="_blank" class="hover:text-indigo-600 dark:text-gray-200 dark:hover:text-indigo-300">
    ...
    <ul class="flex flex-col gap-y-1">
      <li>
        <NuxtLink
          to="/playlists/prettier/lessons/getting-started-with-prettier"
        ...
        >
          <span class="truncate text-sm font-medium sm:text-base">1. Getting Started with Prettier</span>
          <span class="text-sm text-gray-500 sm:text-base">5:30</span>
        </NuxtLink>
      </li>
      <li>
        <NuxtLink
          to="/playlists/prettier/lessons/advanced-gitlens-features"
        ...
        >
          <span class="truncate text-sm font-medium sm:text-base">2. Advanced GitLens Features</span>
          <span class="text-sm text-gray-500 sm:text-base">8:45</span>
        </NuxtLink>
      </li>
      <li>
        <NuxtLink
          to="/playlists/prettier/lessons/debugging-with-eslint"
          class="flex w-full items-center justify-between gap-x-4 rounded-lg p-3 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"
        >
          <span class="truncate text-sm font-medium sm:text-base">3. Debugging with ESLint</span>
