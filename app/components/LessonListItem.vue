...
const linkClasses = computed(() => [
  ...
  useRoute().params.lessonSlug === lessonSlug ? 'bg-indigo-50 text-indigo-700 dark:bg-gray-700' : 'text-gray-600 hover:bg-gray-100',
]);
</script>
...
<template>
  <li>
    <NuxtLink
      ...
      :class="linkClasses"
    >
      <span class="truncate text-sm font-medium sm:text-base"> {{ lesson.number }}. {{ lesson.title }} </span>
